...
alone, and Appendix D of [`SPEC.md`](./SPEC.md) says what it is.
...
of [`SPEC.md`](./SPEC.md) lists every change version 2 made and what each cost
a message written against version 1.
